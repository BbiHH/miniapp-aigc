...
Page({
  ...
  onCardTap(e) {
    ...
    if (card.desc.includes('数字人')) {
      wx.navigateTo({ url: '/pages/release/digital-human/index' });
    } else if (card.desc.includes('动画')) {
      wx.navigateTo({ url: '/pages/release/animation/index' });
    } else {
      wx.navigateTo({ url: '/pages/release/common/index' });
    }
  }
});
